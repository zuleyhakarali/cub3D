...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2026/08/30 11:17:08 by zkarali           #+#    #+#             */
/*   Updated: 2026/08/30 11:21:06 by zkarali          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	init_screen_buffer(t_cub *game)
{
	...
	mlx->screen_b.pix_ptr = mlx_get_data_addr(mlx->screen_b.img,
			&mlx->screen_b.bits_per_pix,
